...
This file holds the functional aspect of the template, directed by one flow responsible of conducting the business logic.<!-- Default Business Logic XML (end) -->
...
This is the file where you will find the inbound and outbound sides of your integration app. It is intented to define the application API.<!-- Default Endpoints XML (end) -->
